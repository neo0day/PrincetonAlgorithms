...
public class Graph {
	...
	/**
	 * Ex 4.1.8
	 * Search API on page 528 that uses UF
	 */
	public class Search {
		private int s;
	...
	/**
	 * Ex 4.1.10
	 * vertex whose removal (including all incident edges) will not disconnect the graph
	 * 		  
	 */
	public List<Integer> non_articulation_vertex() {
		vertexClassification();
		List<Integer> list = new ArrayList<Integer>();
		System.out.println("non-articulation debug: \n# disc/low");
		for (int i = 0; i < V; i++) {
			if (!articulation[i])
				list.add(i);
	...
	/**
	 * Ex 4.1.15
	 * allow adjacency lists from standard input 
	 */
